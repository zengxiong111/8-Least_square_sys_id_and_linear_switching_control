function [M_all,tau_all,Xi_all] = inputs_alg2(A_t_all,B_t_all,C_t_all,epsilon_a,epsilon_c,sigma_w_2,sigma_u_2,sigma_v_2)
...
tau_all(1) = max([1600/9*log(1/delta),...
   1/log(1+epsilon_a)*(6400*epsilon_c/(9*sigma_w_2*delta)*(M_1 + ...
   c_r *log(2/delta)*n^2 * m_a^(4*n) + c_s * log(1/delta) ))]);
for j= 2:N
